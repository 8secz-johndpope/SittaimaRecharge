		...
		return (
			<div>
				<ExpansionPanel
					elevation={0}
					expanded={expanded}
					onChange={handleChange(sideLink.sidebarName[selectedLanguage])}
				...
				>
					...
					>
						<div className={classes.category}>
							{sideLink.icon} {sideLink.sidebarName[selectedLanguage]}
						</div>
					</ExpansionPanelSummary>
									...
									<div className={classes.eachLink} key={key}>
										...
										>
											...
											>
												...
												<ListItemText
													primary={each.sidebarName[selectedLanguage]}
